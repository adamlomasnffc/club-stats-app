    ...
    if subtab == "Player Stats":
        try:
         ...
         table_html = (
                ...
                "<table style='width:100%; border-collapse: collapse; text-align: center; font-family: sans-serif; min-width: 650px;'>"
                "<tr style='background-color: #FFB81C; color: #111; font-weight: bold;'>"
            )
